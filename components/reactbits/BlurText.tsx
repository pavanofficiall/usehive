...
// Adapted from React Bits BlurText for inline headings and an intro-controlled start.
...
const BlurText: React.FC<BlurTextProps> = ({
  ...
  const reducedMotion = prefersReduced || (phone && className.includes("footer-blur"));
  ...
  }, [threshold, rootMargin, play, reducedMotion]);
